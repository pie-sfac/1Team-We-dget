                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FutureBuilder(
                          ...
                          builder: (context, snapshot) {
                            if (snapshot.hasData && snapshot.data != null) {
                              final PainHistory painHistory =
                                  snapshot.data!.painHistory;
                              final List<PainHistoryItem> painHistoryItem =
                                  snapshot.data!.painHistory.items;
                                        ...
                                        LineChartData(
                                          ...
                                          titlesData: FlTitlesData(
                                            ...
                                            bottomTitles: AxisTitles(
                                              ...
                                              showTitles: true,
                                              getTitlesWidget: (value, meta) {
                                                final date = painHistory
                                                    .items[value.toInt()].date;
                                                final formattedDate =
                                                    DateFormat('yy.MM.dd')
                                          ...
                                          minX: 0,
                                          maxX: painHistoryItem.length
                                                  .toDouble() -
                                              1,
                                          minY: 0,
                                          maxY: painHistory.items
                                              .fold(
                                                  0,
                                                  (max, item) =>
                                                      item.level > max
                                          ...
                                          children: [
                                            CircleAvatar(
                                              backgroundImage: AssetImage(
                                                  'assets/${person!.condition.items[index].condition}.png'),
                                              radius: 20,
                                            ),
                                            Text(translateCondition(person!
                                                .condition
                                                .items[index]
                                                .condition)),
                                            Text(DateFormat('yy.MM.dd').format(
                                                DateTime.parse(person!.condition
                                                    .items[index].date))),
                                          ],
                                        ),
                                      );
                        ...
                        return StatefulBuilder(builder: (context, setState) {
                          return Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                    '${snapshot.data!.member.name} 회원님의 운동 기록입니다.'),
                                DropdownButton<String>(
                                  ...
                                  items: exercises
                                      .map((exerciseItem) => DropdownMenuItem(
                                            child:
